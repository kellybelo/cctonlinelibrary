...
$q = $DBH->prepare("select * from video");
// running the SQL
$q->execute();
...
<body>	
	...
	<div data-role="page" id="page">		
		<div data-role="header" style="background-color:white;">
			<div class="ui-grid-d">
				...
				<a href="https://www.cct.ie/"><img src="./img/cct.jpg"></a>
				</div>
	...
	   		<ul>
				...
				?>
				<li><a href="video.php" data-ajax="false" class="ui-btn-active">Video</a></li>
...
    			<input id="inset-autocomplete-input" data-type="search" placeholder="Search video titles or video category...">
			</form>
			<ul data-role="listview" data-inset="true" data-filter="true" data-filter-reveal="true" data-input="#inset-autocomplete-input">
				<?php
					
					foreach($rows as $r){
						echo "<li><a data-ajax='false', href='video.php?id=" . $r['video_id'] ."'>" . $r['title'] . " - " . $r['category'] . "</a></li>";		
					}
			...
			<?php
				if(isset($_GET['id'])) {
					...
					echo '<iframe id="player" width="800" height="385" src="' . $rows[$_GET['id']-1]['link'] . '" frameborder="0"></iframe>';
				}
			?>
		</div >	
